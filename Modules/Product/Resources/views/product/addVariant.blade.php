...
@section('title') Create Product Variant @endsection
...
<div class="card">
    <div class="card-body">
        ...
        <x-backend.section-header>
            <i class="fas fa-sitemap"></i> Product Variant <small class="text-muted">Create</small>
        ...
        <div class="row mt-4">
            <div class="col">
                <form action="{{ route('backend.product.storeVariant', $product_id) }}" method="post" id="productForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row mbb-3">
                        <div class="col">
