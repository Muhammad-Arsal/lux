...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                <form action="{{ route('backend.product.store') }}" method="post" id="productForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row mbb-3">
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control" value="{{ old('product_name') }}" name="product_name" id="product_name" placeholder="Name">
                            </div>
                            @error('product_name')
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input offer_availability" type="radio" name="offer_availability" value="yes">
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input offer_availability" type="radio" name="offer_availability" value="no">
                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                </div>
                    ...
                    <div class="row mb-3 offer_availability_yes" style="display: none">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input offer_type" type="radio" name="offer_type" value="free">
                                    <label class="form-check-label" for="inlineRadio1">Free</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input offer_type" type="radio" name="offer_type" value="off">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ old('variant_name') }}" name="variant_name" id="variant_name" placeholder="Name">
                            </div>
                            @error('variant_name')
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="variant_price" value="{{ old('variant_price') }}" id="variant_price" size="5">$
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="discount_price" value="{{ old('discount_price') }}" id="discount_price"  size="5">$
