...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col">
                    <form action="{{ route('backend.customer.update', $collected_data->id) }}" method="post"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="first_name" id="first_name"
                                        value="{{ $collected_data->first_name }}" placeholder="First Name">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $collected_data->last_name }}" class="form-control"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->email }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->phone }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Fax</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->fax }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Company</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->company }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->address }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>City</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->city }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>State</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->state }}"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    <label>Zip</label>
                                    <input type="text" class="form-control" value="{{ $collected_data->zip }}"
